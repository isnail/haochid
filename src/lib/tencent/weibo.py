...
def _http_call(the_url, method, authorization, **kw):
    ...
    try:
        ...
        if not kw.get('format') == 'json':
            body = dict(((v.split('=')[0], v.split('=')[1]) for v in body.split('&')))
...
class APIClient(object):
    ...
    def __init__(self, app_key, app_secret, redirect_uri=None, response_type='code'):
        ...
        self.api_url = 'http://open.t.qq.com/api/'
    ...
    def set_access_token(self, access_token, expires, open_id, ip):
